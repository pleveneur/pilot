...
- NE DUPLIQUE PAS ce qui est déjà dans AGENTS.md : ce fichier contient les règles stables et prescriptives du projet (déjà dans ton contexte système). PROJECT_MEMORY.md ne doit contenir que des faits APPRIS en exécutant (pièges rencontrés, décisions contextuelles, dépendances découvertes), pas des recopies de règles déjà énoncées dans AGENTS.md.
